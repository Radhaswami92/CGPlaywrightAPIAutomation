...
## Terminal COmmands to run the test case using dynamic url and browser, keyword, tagging test cases:
# >python -m pytest test_Section11_Framework_63_64.py --browser_name firefox --url_name PAC -s
# Below using keyword present in test case name
# python -m pytest -k products -s
# Below using tagging test cases(wherever used @pytest.mark.smoke
#python -m pytest -m smoke
#

with open("Learn_Playwright_BDD_Framework/Data/payload.json") as fil_read:
