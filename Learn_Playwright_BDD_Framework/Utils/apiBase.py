...
class APIUtils:
    ...
    def log_in_api_get_token(self, playwright: Playwright, login_payload):
    ...
    def create_order_api(self, pwr: Playwright, login_payload):
        token = self.log_in_api_get_token(pwr, login_payload)
