...
## Terminal COmmands to run the test case in parallel mode
# >python -m pytest -n 3(3 is no. of parallel executions at a time)
#pre-requisite (intall the pytest-xdist using command pip install pytest-xdist)
