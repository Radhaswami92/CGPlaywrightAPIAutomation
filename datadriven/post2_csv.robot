...
Library    Collections
Library    DataDriver       file=datadriven/data.csv        encoding=utf_8      dialect=unix
...
*** Test Cases ***
Add video game with the dictionary data as ${id}       ${name}     ${releaseDate}      ${reviewScore}      ${category}     ${rating}       ${expected_response_code}   ${header_type}
