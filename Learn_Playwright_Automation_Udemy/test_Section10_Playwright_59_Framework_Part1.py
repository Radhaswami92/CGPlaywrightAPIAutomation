...
from Learn_Playwright_Automation_Udemy.Utils.apiBaseReadData import ReadAPIUtils

from Learn_Playwright_Automation_Udemy.Utils.apiBase import APIUtils


def test_login_and_validate_orderId(playwright: Playwright):
    ...
    api_order_id = api_base_class_obj.create_order_api(playwright)
    ...
    expect(page.locator(".col-md-6").filter(has_text="Order Id").locator(".col-text.-main")).to_contain_text(api_order_id)
    time.sleep(5)
